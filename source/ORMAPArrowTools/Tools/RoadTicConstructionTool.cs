...
{
    /// <summary>
    /// RoadTicConstructionTool class.
    /// </summary>
    /// <remarks>Road tic construction tool class.</remarks>
    internal class RoadTicConstructionTool : MapTool
    {
        ...
        /// Constructor.
        /// </summary>
        public RoadTicConstructionTool()
        {
        ...
        protected override async Task OnToolActivateAsync(bool hasMapViewChanged)
        {
            try
            {
                ...
                {
                    Category = ArrowContext.ArrowCategory.RoadTic,
        ...
        protected override Task<bool> OnSketchCompleteAsync(Geometry geometry)
        {
            try
            {
                ...
                bool addPoints = !ArrowContext.UpdateEndPoint &&
                    ArrowContext.CurrentArrowType.Category == ArrowContext.ArrowCategory.RoadTic &&
            ...
            try
            {
                if (notifyCollectionChangedEventArgs.Action == NotifyCollectionChangedAction.Add)
                {
                    ...
                    else if (ArrowContext.MapPoints.Count == 2)
                    {
                        ...
                        editOpType = ArrowContext.UpdateEndPoint ? ArrowUtils.EditOpType.Modify : ArrowUtils.EditOpType.Create;
