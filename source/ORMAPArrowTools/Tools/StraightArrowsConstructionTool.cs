...
{
    /// <summary>
    /// StraightArrowsConstructionTool class.
    /// </summary>
    /// <remarks>Straight arrows construction tool class.</remarks>
    internal class StraightArrowsConstructionTool : MapTool
    {
        ...
        /// Constructor.
        /// </summary>
        public StraightArrowsConstructionTool()
        {
        ...
        protected override async Task OnToolActivateAsync(bool hasMapViewChanged)
        {
            try
            {
                ...
                {
                    Category = ArrowContext.ArrowCategory.Straight,
